...
public class Calculator {	
	public static void main(String[] args) {	
		...
		System.out.println("Informe a equação entre os parênteses:");
		...
		else {System.out.println("Por favor, insira apenas números inteiros que estejam entre os parênteses: "); break;}			
		a++;						
	}
